...
import 'package:teamawesomesozeith/pages/admin/admin_app_version_page.dart';
...
import 'package:teamawesomesozeith/pages/admin/admin_team_rules_page.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          _AdminTile(
            ...
            title: 'Team Rules',
            subtitle: 'Post rules players must follow',
            color: const Color(0xFF5D4037),
            onTap: () => _open(context, const AdminTeamRulesPage()),
          ),
          ...
          _AdminTile(
            ...
            title: 'Force Update',
            subtitle: 'Set minimum version or maintenance mode',
            color: const Color(0xFFC62828),
            onTap: () => _open(context, const AdminAppVersionPage()),
          ),
          const SizedBox(height: 24),
